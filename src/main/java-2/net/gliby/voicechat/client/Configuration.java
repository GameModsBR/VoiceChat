        ...
        try {
            if (this.location.exists()) {
                ...
                if (defaultDevice != null) {
                    this.settings.setInputDevice(handler.getDeviceByName(this.init.ReadString("Audio", "InputDevice", defaultDevice.getName())));
                }
                ...
                this.settings.setSpeakMode(this.init.ReadFloat("Audio", "SpeakMode", Float.valueOf(0.0f)).intValue());
