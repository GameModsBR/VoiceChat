        ...
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                try {
                    ...
                    if (newDefault.ID != ServerSettings.this.getModPackID()) {
                        VoiceChat.getLogger().info("Modpack defaults applied, original settings overwritten.");
                        ServerSettings.this.setCanShowVoicePlates(newDefault.SHOW_PLATES);
                        ServerSettings.this.setCanShowVoiceIcons(newDefault.SHOW_PLAYER_ICONS);
                        ServerSettings.this.setModPackID(newDefault.ID);
