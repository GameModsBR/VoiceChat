...
extends LspQuant {
    public final void quant(float[] arrf, float[] arrf2, int n, Bits bits) {
        ...
        int n5 = NbLspQuant.lsp_quant(arrf2, 0, Codebook.cdbk_nb, 64, n);
        bits.pack(n5, 6);
        n2 = 0;
        while (n2 < n) {
            float[] arrf6 = arrf2;
        ...
        n5 = NbLspQuant.lsp_weight_quant(arrf2, 0, arrf3, 0, Codebook.cdbk_nb_low1, 64, 5);
        bits.pack(n5, 6);
        n2 = 0;
        while (n2 < 5) {
            float[] arrf7 = arrf2;
            int n7 = n2++;
            arrf7[n7] = arrf7[n7] * 2.0f;
        }
        n5 = NbLspQuant.lsp_weight_quant(arrf2, 0, arrf3, 0, Codebook.cdbk_nb_low2, 64, 5);
        bits.pack(n5, 6);
        n5 = NbLspQuant.lsp_weight_quant(arrf2, 5, arrf3, 5, Codebook.cdbk_nb_high1, 64, 5);
        bits.pack(n5, 6);
        n2 = 5;
        while (n2 < 10) {
            float[] arrf8 = arrf2;
            int n8 = n2++;
            arrf8[n8] = arrf8[n8] * 2.0f;
        }
        n5 = NbLspQuant.lsp_weight_quant(arrf2, 5, arrf3, 5, Codebook.cdbk_nb_high2, 64, 5);
        bits.pack(n5, 6);
        n2 = 0;
        while (n2 < n) {
            float[] arrf9 = arrf2;
            int n9 = n2++;
            arrf9[n9] = (float)((double)arrf9[n9] * 9.7656E-4);
        }
        for (n2 = 0; n2 < n; ++n2) {
    ...
    public final void unquant(float[] arrf, int n, Bits bits) {
        ...
        this.unpackPlus(arrf, Codebook.cdbk_nb_low2, bits, 9.7656E-4f, 5, 0);
        this.unpackPlus(arrf, Codebook.cdbk_nb_high1, bits, 0.0019531f, 5, 5);
        this.unpackPlus(arrf, Codebook.cdbk_nb_high2, bits, 9.7656E-4f, 5, 5);
    }
}
