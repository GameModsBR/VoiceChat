...
public class NbLspQuant extends LspQuant {
   ...
   public final void quant(float[] var1, float[] var2, int var3, Bits var4) {
      ...
      var8 = lsp_weight_quant(var2, 0, var9, 0, Codebook.cdbk_nb_low2, 64, 5);
      var4.pack(var8, 6);
      var8 = lsp_weight_quant(var2, 5, var9, 5, Codebook.cdbk_nb_high1, 64, 5);
      var4.pack(var8, 6);

      for(var5 = 5; var5 < 10; ++var5) {
         var2[var5] *= 2.0F;
      }

      var8 = lsp_weight_quant(var2, 5, var9, 5, Codebook.cdbk_nb_high2, 64, 5);
      var4.pack(var8, 6);

      for(var5 = 0; var5 < var3; ++var5) {
         var2[var5] = (float)((double)var2[var5] * 9.7656E-4D);
      }
