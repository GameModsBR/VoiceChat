   ...
   private boolean load() {
      if(this.location.exists()) {
         try {
            ...
            this.settings.setUDPPort(this.init.ReadInteger("Network", "UDPPort", Integer.valueOf(this.settings.getUDPPort()).intValue()));
            this.settings.setQuality(this.init.ReadInteger("Network", "MinimumQuality", Integer.valueOf(this.settings.getMinimumSoundQuality()).intValue()), this.init.ReadInteger("Network", "MaximumQuality", Integer.valueOf(this.settings.getMaximumSoundQuality()).intValue()));
            this.settings.setBufferSize(this.init.ReadInteger("Network", "BufferSize", Integer.valueOf(this.settings.getBufferSize()).intValue()));
